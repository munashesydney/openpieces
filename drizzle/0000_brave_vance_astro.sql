...
CREATE TABLE "services" (
	...
	"spawn_fail_count" integer DEFAULT 0 NOT NULL,
	"qa_spawn_count" integer DEFAULT 0 NOT NULL,
	"hub_piece_id" text,
...
ALTER TABLE "opencode_sessions" ADD CONSTRAINT "opencode_sessions_service_id_services_id_fk" FOREIGN KEY ("service_id") REFERENCES "public"."services"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "workflow_executions" ADD CONSTRAINT "workflow_executions_chat_id_ai_chats_id_fk" FOREIGN KEY ("chat_id") REFERENCES "public"."ai_chats"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "workflow_executions" ADD CONSTRAINT "workflow_executions_task_id_tasks_id_fk" FOREIGN KEY ("task_id") REFERENCES "public"."tasks"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
