    ...
    <div className="rounded-xl border border-[var(--border)] bg-[var(--sidebar-bg)] px-4 py-3">
      <div className="mb-4 flex items-center gap-2 pb-3">
        <div className="rounded-md border border-[var(--border)] bg-[var(--hover-bg)] p-1.5">
          <MessageCircle className="h-3.5 w-3.5 text-[var(--muted)]" />
        </div>
      ...
      <div className="space-y-3">
                ...
                <button
                  ...
                  className={`rounded-full border px-3 py-1.5 text-sm transition-colors ${
                    currentAnswer === answer
                      ...
                      : "border-[var(--border)] bg-[var(--bg)] text-[var(--muted)] hover:border-[var(--foreground)]/40 hover:text-[var(--foreground)]"
                  }`}
                >
                  {answer}
                </button>
        ...
        <input
          ...
          className="w-full rounded-lg border border-[var(--border)] bg-[var(--bg)] px-3 py-2.5 text-sm text-[var(--foreground)] placeholder:text-[var(--muted)] focus:border-[var(--foreground)]/40 focus:outline-none"
        />
      </div>
