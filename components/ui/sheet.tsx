...
export function Sheet({ isOpen, onClose, title, description, children, footer }: SheetProps) {
  ...
  return createPortal(
    <>
      ...
      {/* Sheet */}
      <div
        className={`fixed inset-y-0 right-0 z-50 w-full max-w-[480px] border-l border-[var(--border)] bg-[var(--sidebar-bg)] shadow-[0_0_60px_rgba(124,58,237,0.06)] transition-transform duration-300 ease-out ${
